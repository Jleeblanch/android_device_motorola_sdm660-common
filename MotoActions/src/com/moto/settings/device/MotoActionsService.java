...
package com.moto.settings.device;
...
import com.moto.settings.device.actions.UpdatedStateNotifier;
import com.moto.settings.device.actions.CameraActivationSensor;
import com.moto.settings.device.actions.ChopChopSensor;
import com.moto.settings.device.actions.FlipToMute;
import com.moto.settings.device.actions.LiftToSilence;
import com.moto.settings.device.actions.ProximitySilencer;

import com.moto.settings.device.doze.DozePulseAction;
import com.moto.settings.device.doze.GlanceSensor;
import com.moto.settings.device.doze.ProximitySensor;
import com.moto.settings.device.doze.FlatUpSensor;
import com.moto.settings.device.doze.ScreenReceiver;
import com.moto.settings.device.doze.ScreenStateNotifier;
import com.moto.settings.device.doze.StowSensor;
